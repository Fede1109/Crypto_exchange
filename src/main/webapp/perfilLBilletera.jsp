...
<body>
	...
	String idBilletera = request.getParameter("id_LBilletera");
	String idCriptomoneda = request.getParameter("id_LCriptomoneda");
	L_billetera lbill = new L_billetera();
	Criptomoneda cripto = new Criptomoneda ();
	cripto = BDCont.dameCripto(Integer.parseInt(idCriptomoneda));
	lbill = BDCont.dameLineabilletera(Integer.parseInt(idCriptomoneda), Integer.parseInt(idBilletera));
			...
			<div class="row grid-responsive">
				<div class="column page-heading">
					<div class="large-card">
						<h1>Modificar Linea Billetera</h1>
						<p class="text-large">Aquí podra modificar lineas de billetera</p>
					</div>
					<div class="row grid-responsive">
						<div class="column ">
							<div class="card">
								...
								<div class="card-block">
									<form action="operaciones.jsp?tipo=modificaLBilletera&codClienteLB=<%=lbill.getId_billetera()%>" method="post"
										id="formularioCompleto">
										<fieldset id="bloque">
											<div class="datos">
												<div class="elementosDerecha" style="width: 45%">
													<div class="dropdown">
														<select id="clienteCriptoModificado" name="clienteCriptoModificado"
															is="ms-dropdown" style="width: 400px"
															data-child-height="400">
															<option value="<%=lbill.getId_criptomoneda()%>" data-image="images/criptos/<%=cripto.getId_crypto()%>.png"><%=cripto.getNombre() %></option>
															<%
															...
															%>
														</select> <label for="valorField">Unidades</label> <input
															type="text" maxlength="12" value="<%=lbill.getUnidades()%>"
															id="valorField" name="unidadesModifica">
													</div>
