...
<body>
	...
	ArrayList<Compras> compras = controladorBD.todasCompras();
	%>
	<div class="navbar">
		<div class="row">
			...
			<div class="column column-40 col-search">
				<a href="index.jsp" class="search-btn fa fa-search"></a> <input type="text"
			...
			<div class="row grid-responsive">
				<div class="column page-heading">
					<div class="large-card">
						<h1>Baja Compra</h1>
						<p class="text-large">Aquí podra realizar la baja de las compras</p>
					</div>
					<div class="row grid-responsive">
						<div class="column ">
							<div class="card">
								...
								<div class="card-block">
									<form action="operaciones.jsp?tipo=bajacompra" method="post"
										id="formularioCompleto">
										<fieldset id="bloque">
											<div class="datos">
												<div class="elementosDerecha" style="width: 45%">
													<div class="dropdown">
														<select required id="compra" name="compra" is="ms-dropdown"
															...
															<option value="<%=compras.get(i).getId_compra()%>"
																data-image="images/criptos/<%=controladorBD.dameCripto(compras.get(i).getId_criptomoneda()).getId_crypto()%>.png" ><%=compras.get(i).getUnidades()%> unidades de<%=controladorBD.dameCripto(compras.get(i).getId_criptomoneda()).getNombre()%> </option>
															<%
															}
															%>
														</select>														
														<input class="button-primary" type="submit"
															...
															style="width: 200px; margin-top: 2.5rem">
													</div>
												</div>
										</fieldset>
									</form>
