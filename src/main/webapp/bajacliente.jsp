			...
			<div class="row grid-responsive">
				<div class="column page-heading">
					<div class="large-card">
						<h1>Baja Cliente</h1>
						<p class="text-large">Aquí podra realizar la baja de los
							clientes</p>
					</div>
					<div class="row grid-responsive">
						<div class="column ">
											...
											<div class="datos">
												<div class="elementosDerecha" style="width: 45%">
													<div class="dropdown"style="display: flex;flex-direction: column;gap: 2rem;">
														<select required id="cliente" name="cliente" is="ms-dropdown"
															style="width: 400px" data-child-height="400">
															<option value="">Seleccione el cliente que desee
																eliminar</option>
															<%
															for (int i = 0; i < clientes.size(); i++) {
															%>
															<option data-image="assets/images/avatars/<%=clientes.get(i).getId_cliente()%>.png" value="<%=clientes.get(i).getId_cliente()%>"><%=clientes.get(i).getNombre()%></option>
															<%
															}
															%>
														</select>
														<div class="alert background-warning" style="width: 500px"><em class="fa fa-warning"></em>Se borrarán todos los datos y operaaciones realcionadas con el cliente</div> 
														<input class="button-primary" type="submit"
															id="botonOperaciones" value="Realizar Baja" style="width: 200px">
													</div>
												</div>
										</fieldset>
									</form>
