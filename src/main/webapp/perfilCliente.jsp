			...
			<div class="row grid-responsive">
				<div class="column page-heading">
					<div class="large-card">
						...
						<p class="text-large">Aquí podra realizar la modificacion de los nuevos clientes</p>
					</div>
			<div class="row grid-responsive">
				<div class="column ">
					<div class="card">
						<div class="card-title">
							...
							cli = BDCont.dameCliente(Integer.parseInt(idCliente));
							%>
						</div>
						<div class="card-block">
							<form action="operaciones.jsp?tipo=modificacliente&id_clienteModifica=<%=cli.getId_cliente()%>" method="post" id="formularioCompleto">
								<fieldset id ="bloque">
								<div class = "datos" style = "gap:5rem;">
								<div class = "elementosDerecha" style="width: 45%">
									<label for="nameField">Nombre</label>
									<input type="text" required name = "nombreModifica"value="<%=cli.getNombre() %>" id="nameField">
									<label for="apellidoField">Apellidos</label>
									<input type="text" required name = "apellidosModifica" value="<%=cli.getApellidos()%>"  id="apellidoField">									
									<label for="apellidoField">DNI</label>
									<input type="text" required name = "dniModifica" value="<%=cli.getDni()%>" maxlength="9" id="dniField">
									</div>
									<div class = "elementosIzquierda" style="width: 45%">
									<label for="direccionField">Direccion</label>
									<input type="text" required value="<%=cli.getDireccion()%>"  id="direccionField"  name ="direccionModifica">
									<label for="CPField">Código Postal</label>
									<input type="number" required value="<%=cli.getCodigo_Postal()%>"  id="CPField" name ="CPModifica" maxlength="5">
									<label for="provinciaField">Provincia</label>
									<input type="text" required value="<%=cli.getProvincia()%>"  id="provinciaField" name ="provinciaModifica">	
