	...
	<div class="row">
		<div id="sidebar" class="column">
			...
			<ul>
				...
				<li><a href="#charts"><em class="fa fa-bar-chart"></em> Alta Billetera</a></li>
				<li><a href="#widgets"><em class="fa fa fa-clone"></em> Alta criptomoneda</a></li>
				<li><a href="#forms"><em class="fa fa-pencil-square-o"></em>Alta l_billetera</a></li>
				<li><a href="#alerts"><em class="fa fa-warning"></em> Baja Cliente</a></li>
				<li><a href="#buttons"><em class="fa fa-hand-o-up"></em> Baja Billetera</a></li>
				<li><a href="#tables"><em class="fa fa-table"></em> Baja criptomoneda</a></li>
				<li><a href="#grid"><em class="fa fa-columns"></em> Baja l_billetera</a></li>
			</ul>
		</div>
			...
			<div class="row grid-responsive">
				<div class="column page-heading">
					<div class="large-card">
						<h1>Bievenido!</h1>
						<p class="text-large">Este es el panel de administrador. En el podrás realizar las operaciones que desees.<br> Seleccione en el panel izquierdo la operación que desee realizar.
						</p>
