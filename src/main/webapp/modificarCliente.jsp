...
<body>
	<div class="navbar">
		<div class="row">
			<div class="column column-30 col-site-title"><a href="index.html" class="site-title float-left">Medialoot</a></div>
			...
			<div class="row grid-responsive">
				<div class="column page-heading">
					<div class="large-card">
						...
						<p class="text-large">Aquí podrá modificar el cliente</p>
					</div>
			<div class="row grid-responsive">
				<div class="column ">
					<div class="card">
						...
						<div class="card-block">
							<form action="operaciones.jsp?tipo=altacliente" method="post" id="formularioCompleto">
								...
								<div class = "elementosDerecha" style="width: 45%">
									...
									<input type="text" required maxlength="20" name = "nombreModifica"placeholder="Introduzca su nombre" id="nameField">
									<label for="apellidoField">Apellidos</label>
									<input type="text" required maxlength="20" name = "apellidosModifica" placeholder="Introduzca sus apellidos" id="apellidoField">
									<label for="ageRangeField">Edad</label>
									<input type="number" required maxlength="2" name = "edadModifica" placeholder="Introduzca su edad" maxlength="2" id="edadField">
									<label for="apellidoField">DNI</label>
									<input type="text" required maxlength="9" name = "dniModifica" placeholder="Introduzca su dni" maxlength="9" id="dniField">
									</div>
									<div class = "elementosIzquierda" style="width: 45%">
									<label for="direccionField">Direccion</label>
									<input type="text" required maxlength="30" placeholder="Introduzca sus direccion" id="direccionField"  name ="direccionModifica">
									<label for="CPField">Código Postal</label>
									<input type="number" required maxlength="5" placeholder="Introduzca su CP" id="CPField" name ="CPModifica" maxlength="5">
									<label for="provinciaField">Provincia</label>
									<input type="text" required maxlength="20" placeholder="Introduzca sus Provincia" id="provinciaField" name ="provinciaModifica">	
